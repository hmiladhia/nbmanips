...
class CellOutput:
    output_type = None
    _output_types: ClassVar[dict[str, type]] = {}
    _parsers: ClassVar[dict[str, ParserBase]] = {}
    ...
    def byte_size(self, output_types: set | None):
...
class DataOutput(CellOutput):
    _default_data_types: ClassVar[list[str]] = ["text", "image", "text/html"]
